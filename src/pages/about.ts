...
const about = () =>
{
    ...
    <section class="child abt" id="about" style="align-items:normal">
        ...
        <a href="https://drive.google.com/file/d/1NQL_jJP0DZZJQhvZmWlZxaCTs6f7J0JA/view?usp=sharing" style="align-self: flex-start; font-size: 1.8em;margin-top:2%;" class="gliched-move gliched-text" >
