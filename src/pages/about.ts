...
const about = () =>
{
    ...
    <section class="child" id="about" style="align-items:normal">
        ...
        <a href="https://drive.google.com/file/d/1a81pmC4I53NUrW1sA30eGz5C944K0sQI/view?usp=sharing" style="align-self: flex-start; font-size: 1.8em;margin-top:2%;" class="gliched-move gliched-text social-item" >My RESUME</a>
